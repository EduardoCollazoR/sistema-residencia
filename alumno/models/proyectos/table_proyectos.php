...
$sql= 'SELECT * FROM proyecto as py INNER JOIN empresa as e ON py.empresa_id= e.empresa_id  WHERE py.estado_proyecto =1 AND py.tipo_proyecto!=0';
...
$consulta[$i]['informacion']= '<button class="btni btn-info" title="Informacion de empresa" onclick="infoEmpresa('.$consulta[$i]['empresa_id'].')"
