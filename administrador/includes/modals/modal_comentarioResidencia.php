<!-- Modal Comentarios-->
<div class="modal fade" id="modalComentarioResi" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formComentarioResi" name="formComentarioResi">
                ...
                <button class="btn btn-primary" id= "btncomentario" type="submit">Guardar</button>
            </div>
                </form>
            </div>
        </div>
