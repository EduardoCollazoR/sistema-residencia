...
$consulta[$i]['acciones']= '
<button class="btni btn-info" title="Editar" onclick="editPeriodo('.$consulta[$i]['periodo_id'].')"
><i class="fas fa-edit "></i></button>
<button class="btni btn-danger" title="Eliminar" onclick="deletePeriodo('.$consulta[$i]['periodo_id'].')"
