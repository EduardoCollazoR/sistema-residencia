...
$consulta[$i]['acciones']= '
<button class="btni btn-info" title="Editar" onclick="editProfesor('.$consulta[$i]['profesor_id'].')"
><i class=" fas fa-edit "></i></button>
<button class="btni btn-danger" title="Eliminar" onclick="deleteProfesor('.$consulta[$i]['profesor_id'].')"
